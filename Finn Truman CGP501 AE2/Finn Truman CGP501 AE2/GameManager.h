...
public:
	...
	//unlike the other collision methods, this one does not apepar in the Actor class, because the gameManager is the class that has access to all the gameObjects
	//this is a bit of bad design, but its a hole that I dug myself into and need to adapt to work around
